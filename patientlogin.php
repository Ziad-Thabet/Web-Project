...
if(isset($_POST['submit']))
{
	...
	{
		$AppLogin = mysqli_fetch_array($query);
		$_SESSION['patientid']= $AppLogin['patientid'] ;
		echo "<script>window.location='patientaccount.php';</script>";
	}
	else
	{
...
<title>Trex's Hospital Patient</title>
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Trex'S Hospital</span>Login <span class="msg">Hello, Patient!</span></h1>
        <div class="col-md-12">
