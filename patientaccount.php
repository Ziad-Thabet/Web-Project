...
$querypatientappointment = mysqli_query($con,$sqlpatientappointment);
$SelectAppointment = mysqli_fetch_array($querypatientappointment);
?>
                ...
                <div class="card">
                    <div class="header">
                        <div class="alert bg-teal">
                            <h3>Welcome , <?php echo $SelectPatient['patientname']; ?>! </h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="tab-content" style="padding: 10px">
                    <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1"
                        ...
                        <h3>You are with us from <?php echo $SelectPatient['admissiondate']; ?>
                            <?php echo $SelectPatient['admissiontime']; ?></h3>
                    </div>
                    <div role="tabpanel" class="tab-pane animated flipInX" id="profile_animation_1"
                        aria-expanded="false"> <b>Appointment</b>
                        <?php
                        if(mysqli_num_rows($querypatientappointment) == 0)
                        {
                            ?>
                        ...
                        {
                            ?>
                        <h3>Last Appointment taken on - <?php echo $SelectAppointment['appointmentdate']; ?>
                            <?php echo $SelectAppointment['appointmenttime']; ?> </h3>
                        <?php
                        }
                        ?>
                    </div>
