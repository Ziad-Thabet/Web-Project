...
if(isset($_POST['submit']))
{
	...
	if(mysqli_num_rows($query) == 1)
	{
		...
		$_SESSION['doctorid']= $SelectDoctor['doctorid'] ;
		echo "<script>window.location='doctoraccount.php';</script>";
	}
	else
	{
...
<title>Trex's Hospital Doctor</title>
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Trex's Hospital</span>Login <span class="msg">Hello, Doctor!</span></h1>
        <div class="col-md-12">
