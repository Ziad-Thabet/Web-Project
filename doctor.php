		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<form method="post" action="" name="frmdoct" onSubmit="return validateform()" style="padding: 10px">
					...
					<div class="form-line">
					<input class="form-control" type="text" name="doctorname" id="doctorname" value="<?php echo $SelectDoctor['doctorname']; ?>" />
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="text" name="mobilenumber" id="mobilenumber" value="<?php echo $SelectDoctor['mobileno']; ?>"/>
				</div>
				</div>
					...
					<select  name="select3" id="select3" class="form-control show-tick">
						...
						{
							if($SelectDepartment['departmentid'] == $SelectDoctor['departmentid'])
							{
					...
					<div class="form-line">
					<input class="form-control" type="text" name="loginid" id="loginid" value="<?php echo $SelectDoctor['loginid']; ?>"/>
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="password" name="password" id="password" value="<?php echo $SelectDoctor['password']; ?>"/>
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="password" name="cnfirmpassword" id="cnfirmpassword" value="<?php echo $SelectDoctor['password']; ?>"/>
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="text" name="education" id="education" value="<?php echo $SelectDoctor['education']; ?>" />
				</div>
				</div>
					...
					<div class="form-line">
					<input class="form-control" type="text" name="experience" id="experience" value="<?php echo $SelectDoctor['experience']; ?>"/>
				</div>
				</div>
