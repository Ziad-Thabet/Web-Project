...
{
		$sql ="UPDATE patient SET patientname='$_POST[patientname]',admissiondate='$_POST[admissiondate]',admissiontime='$_POST[admissiontme]',address='$_POST[address]',city='$_POST[city]',mobileno='$_POST[mobilenumber]',pincode='$_POST[pincode]',loginid='$_POST[loginid]',gender='$_POST[select3]',dob='$_POST[dateofbirth]' WHERE patientid='$_SESSION[patientid]'";
                            ...
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        ...
                                        <input class="form-control" type="text" name="patientname" id="patientname"  value="<?php echo $SelectPatient['patientname']; ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        ...
                                        <input class="form-control" type="date" name="admissiondate" id="admissiondate" value="<?php echo $SelectPatient['admissiondate']; ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">                                 	
                                        ...
                                        <input class="form-control" type="time" name="admissiontme" id="admissiontme" value="<?php echo $SelectPatient['admissiontime']; ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group ">
                                	...
                                	<div class="form-line">
                                    <input class="form-control" name="address" id="address" value="<?php echo $SelectPatient['address']; ?>" /> 
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-group ">
                                	...
                                	<div class="form-line">
                                    <input class="form-control" name="city" id="city" value="<?php echo $SelectPatient['city']; ?>" /> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            <div class="col-sm-6 col-xs-12">
                                <div class="form-group">
                                	...
                                	<div class="form-line">
                                    <input class="form-control" type="text" name="mobilenumber" id="mobilenumber" value="<?php echo $SelectPatient['mobileno']; ?>" />
                                    </div>
                                </div>
                            </div>
							<div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                    	...
                                    	<div class="form-line">
                                        <input class="form-control" type="text" name="loginid" id="loginid"  value="<?php echo $SelectPatient['loginid']; ?>"/>
                                    </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                    	...
                                    	<div class="form-line">
                                       <input class="form-control" type="date" name="dateofbirth" id="dateofbirth"  value="<?php echo $SelectPatient['dob']; ?>"/>
                                   </div>
                                    </div>
                                </div>
                            </div>
