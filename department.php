...
if(isset($_GET['editid']))
{
	...
	$SelectDepartment = mysqli_fetch_array($query);
    ...
    <table class="table table-hover">
      <tbody>
        <tr>
          ...
          <td width="66%"><input placeholder=" Enter Here " class="form-control" type="text" name="departmentname" id="departmentname" value="<?php echo $SelectDepartment['departmentname']; ?>" /></td>
        </tr>
        <tr>
          <td>Description</td>
          <td><textarea placeholder=" Enter Here " class="form-control no-resize" name="textarea" id="textarea" cols="45" rows="5"><?php echo $SelectDepartment['description'] ; ?></textarea></td>
        </tr>
        <tr>
          <td>Status</td>
		  ...
		  foreach($arr as $val)
		  {
			  if($val == $SelectDepartment['status'])
			  {
