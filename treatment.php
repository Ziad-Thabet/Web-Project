...
if(isset($_GET['editid']))
{
	...
	$SelectTreatment = mysqli_fetch_array($query);
						...
						<div class="col-sm-4 col-xs-12">
							<div class="form-group">
								...
								<div class="form-line">
									...
									value="<?php echo $SelectTreatment['treatmenttype']; ?>">
								</div>
							</div>
						</div>
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div class="form-line">
								...
								rows="5"><?php echo $SelectTreatment['note'] ; ?></textarea>
